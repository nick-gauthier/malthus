...
The Nefedov model of population-resource dynamics is a simple model of the dynamics of a population and a resource that the population depends on. The model is given by the following set of ordinary differential equations:
