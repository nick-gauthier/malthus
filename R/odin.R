...
adaptive_capacity_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "adaptive_capacity_rhs_dde",
      rhs_desolve = "adaptive_capacity_rhs_desolve",
      initmod_desolve = "adaptive_capacity_initmod_desolve",
      output_dde = "adaptive_capacity_output_dde"),
    dll = "malthus",
    user = c("a1", "a2", "alpha", "b1", "b2", "C", "fmin", "r", "S", "tau1",
             "tau2"),
    ...
    registration = function() {
      if (FALSE) {
        .C("adaptive_capacity_rhs_dde", package = "malthus")
        .C("adaptive_capacity_rhs_desolve", package = "malthus")
        .C("adaptive_capacity_initmod_desolve", package = "malthus")
        .C("adaptive_capacity_output_dde", package = "malthus")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("adaptive_capacity_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "malthus")
    },

    update_metadata = function() {
      meta <- .Call("adaptive_capacity_metadata", private$ptr,
                    PACKAGE = "malthus")
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("adaptive_capacity_create", user, PACKAGE = "malthus")
    ...
    ir = function() {
      path_ir <- system.file("odin/adaptive_capacity.json", mustWork = TRUE,
                             package = "malthus")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("adaptive_capacity_set_user", private$ptr, user, PACKAGE = "malthus")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("adaptive_capacity_initial_conditions", private$ptr, t, PACKAGE = "malthus")
    },

    rhs = function(t, y) {
      .Call("adaptive_capacity_rhs_r", private$ptr, t, y, PACKAGE = "malthus")
    },
    ...
    contents = function() {
      .Call("adaptive_capacity_contents", private$ptr, PACKAGE = "malthus")
    },
...
adaptive_capacity <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("adaptive_capacity")
  adaptive_capacity_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(adaptive_capacity) <- "odin_generator"
attr(adaptive_capacity, "generator") <- adaptive_capacity_
brander_taylor_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "brander_taylor_rhs_dde",
      rhs_desolve = "brander_taylor_rhs_desolve",
      initmod_desolve = "brander_taylor_initmod_desolve"),
    dll = "malthus",
    user = c("alpha", "beta", "K", "L_init", "phi", "r", "sigma"),
    ...
    registration = function() {
      if (FALSE) {
        .C("brander_taylor_rhs_dde", package = "malthus")
        .C("brander_taylor_rhs_desolve", package = "malthus")
        .C("brander_taylor_initmod_desolve", package = "malthus")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("brander_taylor_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "malthus")
    },

    update_metadata = function() {
      meta <- .Call("brander_taylor_metadata", private$ptr,
                    PACKAGE = "malthus")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("brander_taylor_create", user, PACKAGE = "malthus")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/brander_taylor.json", mustWork = TRUE,
                             package = "malthus")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("brander_taylor_set_user", private$ptr, user, PACKAGE = "malthus")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("brander_taylor_initial_conditions", private$ptr, t, PACKAGE = "malthus")
    },

    rhs = function(t, y) {
      .Call("brander_taylor_rhs_r", private$ptr, t, y, PACKAGE = "malthus")
    },
    ...
    contents = function() {
      .Call("brander_taylor_contents", private$ptr, PACKAGE = "malthus")
    },
...
brander_taylor <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("brander_taylor")
  brander_taylor_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(brander_taylor) <- "odin_generator"
attr(brander_taylor, "generator") <- brander_taylor_
...
janssen_stochastic_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "janssen_stochastic_rhs_dde"),
    dll = "malthus",
    user = c("a", "alpha", "c", "epsilon_sdev", "eta", "g", "gamma", "P0",
             "R0", "rb", "rd", "tau"),
    ...
    registration = function() {
      if (FALSE) {
        .C("janssen_stochastic_rhs_dde", package = "malthus")
      }
    },

    ## This only does something in delay models
    set_initial = function(step, y, use_dde) {
      .Call("janssen_stochastic_set_initial", private$ptr, step, y, use_dde,
            PACKAGE= "malthus")
    },

    update_metadata = function() {
      meta <- .Call("janssen_stochastic_metadata", private$ptr,
                    PACKAGE = "malthus")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("janssen_stochastic_create", user, PACKAGE = "malthus")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/janssen_stochastic.json", mustWork = TRUE,
                             package = "malthus")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("janssen_stochastic_set_user", private$ptr, user, PACKAGE = "malthus")
      private$update_metadata()
    },
    ...
    initial = function(step) {
      .Call("janssen_stochastic_initial_conditions", private$ptr, step, PACKAGE = "malthus")
    },

    rhs = function(step, y) {
      .Call("janssen_stochastic_rhs_r", private$ptr, step, y, PACKAGE = "malthus")
    },
    ...
    contents = function() {
      .Call("janssen_stochastic_contents", private$ptr, PACKAGE = "malthus")
    },
...
janssen_stochastic <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("janssen_stochastic")
  janssen_stochastic_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(janssen_stochastic) <- "odin_generator"
attr(janssen_stochastic, "generator") <- janssen_stochastic_
janssen_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "janssen_rhs_dde"),
    dll = "malthus",
    user = c("a", "alpha", "c", "eta", "g", "gamma", "P0", "R0", "rb", "rd",
             "tau"),
    ...
    registration = function() {
      if (FALSE) {
        .C("janssen_rhs_dde", package = "malthus")
      }
    },

    ## This only does something in delay models
    set_initial = function(step, y, use_dde) {
      .Call("janssen_set_initial", private$ptr, step, y, use_dde,
            PACKAGE= "malthus")
    },

    update_metadata = function() {
      meta <- .Call("janssen_metadata", private$ptr,
                    PACKAGE = "malthus")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("janssen_create", user, PACKAGE = "malthus")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/janssen.json", mustWork = TRUE,
                             package = "malthus")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("janssen_set_user", private$ptr, user, PACKAGE = "malthus")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(step) {
      .Call("janssen_initial_conditions", private$ptr, step, PACKAGE = "malthus")
    },

    rhs = function(step, y) {
      .Call("janssen_rhs_r", private$ptr, step, y, PACKAGE = "malthus")
    },
    ...
    contents = function() {
      .Call("janssen_contents", private$ptr, PACKAGE = "malthus")
    },
...
janssen <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("janssen")
  janssen_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(janssen) <- "odin_generator"
attr(janssen, "generator") <- janssen_
nefedov_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
